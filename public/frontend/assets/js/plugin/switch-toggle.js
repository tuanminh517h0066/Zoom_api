;(function ( $, window, document, undefined ) {
    ...
    function CheckToggler ( element, options ) {
        ...
        this._template = '<div class="ui-stoggle on"><div class="ui-stoggle--inner"><div class="ui-stoggle--label-on"><span class="ui-stoggle--label-text">On</span></div><div class="ui-stoggle--label-off"><span class="ui-stoggle--label-text">Off</span></div></div><span class="ui-stoggle--slider"><i></i></span></div>';
    ...
    CheckToggler.prototype = {
        init: function () {
            ...
            this.$uiToggleLabelOnText = $('.ui-stoggle--label-on .ui-stoggle--label-text', this.$uiToggle).html(this.settings.labelOn);
            this.$uiToggleLabelOffText = $('.ui-stoggle--label-off .ui-stoggle--label-text', this.$uiToggle).html(this.settings.labelOff);
